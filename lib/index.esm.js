...
var Button = function (_a) {
    ...
    return (jsx("button", __assign({ type: "button", className: ['storybook-button', "storybook-button--".concat(size), mode].join(' '), style: { backgroundColor: backgroundColor } }, props, { children: jsx("span", __assign({ className: "text-green-300" }, { children: label })) })));
};
